...
class Concentration {
    ...
    private var indexOfOneAndOnlyCard: Int? {
        get {
            ...
            /*  let indicesOfFaceUpCards = cardsCollection.indices.filter() {cardsCollection[$0].isFaceUp} //here indicesOfFaceUpCard is Array of Array.Index which is basically equivalent to Int (unlike String.Index). also filter has a trailing closure here.
